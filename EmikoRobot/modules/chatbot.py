...
async def hmm(client, message):
    ...
    if chat_id in en_chats:
        ...
        test = test.replace("I live in @uputtsupport.", "I live in San Francisco, California.")
        ...
        response = response.replace("I live in San Francisco, California.", "I live in @uputtsupport.")
