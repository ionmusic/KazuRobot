...
def get_user_list(config, key):
    with open(f"{os.getcwd()}/EmikoRobot/{config}", "r") as json_file:
...
class Config(object):
    ...
    OWNER_ID = 5063062493  # If you dont know, run the bot and do /id in your private chat with it, also an integer
