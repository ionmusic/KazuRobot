...
def get_user_list(__init__, key):
    with open(f"{os.getcwd()}/EmikoRobot/{__init__}", "r") as json_file:
...
LOGGER.info("Kazu is starting. | An Kazu Project Parts. | Licensed under GPLv3.")
